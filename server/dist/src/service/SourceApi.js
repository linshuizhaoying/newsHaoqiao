...
const source_1 = require("../db/controllers/source");
// 返回正常数据
const success = (data) => {
    return {
        'state': {
...
exports.addSource = (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield source_1.AddSource({ sourceTitle, url, lang, type, code });
...
exports.allSources = (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    console.log(ctx.request.body);
    const { sourceTitle, url, lang, type, code } = ctx.request.body;
    const result = yield source_1.AllSources();
    console.log(result);
...
exports.removeSource = (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield source_1.RemoveSource(id);
    return ctx.body = success('');
});
exports.updateSource = (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    return ctx.body = yield source_1.UpdateSource(id, { sourceTitle, url, lang, type, code });
});
